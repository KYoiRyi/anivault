...
class VideoControllerConfiguration {
  ...
  /// Whether to enable MetalFX spatial upscaling on Apple platforms.
  ///
  /// This is only effective on iOS/macOS when the native renderer can create
  /// MetalFX resources. Unsupported devices will silently fall back.
  final bool enableMetalFX;

  /// Relative render scale for MetalFX input on Apple platforms.
  ///
  /// Example:
  /// * `0.77` => quality
  /// * `0.67` => balanced
  /// * `0.50` => performance
  final double metalFXScale;
  ...
  const VideoControllerConfiguration({
    ...
    this.enableMetalFX = false,
    this.metalFXScale = 0.67,
  ...
  VideoControllerConfiguration copyWith({
    ...
    bool? androidAttachSurfaceAfterVideoParameters,
      ...
      VideoControllerConfiguration(
        ...
        enableMetalFX: enableMetalFX ?? this.enableMetalFX,
        metalFXScale: metalFXScale ?? this.metalFXScale,
